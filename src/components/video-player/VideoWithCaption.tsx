...
export default function VideoWithCaption({
  ...
  return (
    <div className={`group relative overflow-hidden ${className || ""}`}>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-foreground/95 backdrop-blur-sm px-4 py-1 transition-transform duration-300 ease-out z-20 translate-y-full group-hover:translate-y-0">
